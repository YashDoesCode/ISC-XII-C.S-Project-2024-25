...
Variable Description TableProgram
Sr No.
Variable Name
Data Type
Description
...
Question 16: ✅
A Disarium Number is a number in which the sum of digits to the powers of this repetitive position is qual to the number itself.
...
Question 21: {Shift to DDA/SDA} ⭕⭕⭕(Done)
